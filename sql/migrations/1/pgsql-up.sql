CREATE TABLE "public"."yii_rbac_cycle_db_item" (
...
CREATE INDEX "idx-yii_rbac_cycle_db_item-type" ON "public"."yii_rbac_cycle_db_item" ("type");
CREATE TABLE "public"."yii_rbac_cycle_db_item_child" (
...
CREATE INDEX "idx-yii_rbac_cycle_db_item_child-parent" ON "public"."yii_rbac_cycle_db_item_child" ("parent");
CREATE INDEX "idx-yii_rbac_cycle_db_item_child-child" ON "public"."yii_rbac_cycle_db_item_child" ("child");
CREATE TABLE "public"."yii_rbac_cycle_db_assignment" (
